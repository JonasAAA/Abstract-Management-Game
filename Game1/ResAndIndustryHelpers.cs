...
namespace Game1
{
    ...
    {
        public static Area Area(this RawMatAmounts rawMatAmounts)
        ...
        public static Propor UpdateDonePropor(this Propor donePropor, Propor workingPropor, UDouble producedAreaPerSec, TimeSpan elapsed, Area areaInProduction)
        {
        ...
        public static AllResAmounts CurNeededBuildingComponents(EfficientReadOnlyCollection<(Product prod, UDouble amountPUBA)> buildingComponentsToAmountPUBA, Area curBuildingArea)
            => new
            (
