...
namespace Game1.Resources
{
    public interface IProductClass : IHasToString
    {
        ...
        {
            public EfficientReadOnlyDictionary<IMaterialPurpose, uint> MatPurposeToAmount
                => new()
                {
        ...
        public EfficientReadOnlyDictionary<IMaterialPurpose, uint> MatPurposeToAmount { get; }
