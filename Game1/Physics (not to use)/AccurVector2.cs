namespace Game1.Physics
{
    ...
    public readonly struct AccurVector2
    {
        ...
        public static explicit operator MyVector2(AccurVector2 accurVector2)
            => new((double)accurVector2.formalX / C.accurScale, (double)accurVector2.formalY / C.accurScale);

        public static explicit operator AccurVector2(MyVector2 vector2)
